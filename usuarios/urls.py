...
from .views import UsuariosListView, UsuarioAddView, UsuarioUpdateView, UsuarioDeleteView, UsuariosBloqueadosListView
...
urlpatterns = [
    ...
    path('usuario/bloqueados/', UsuariosBloqueadosListView.as_view(), name='usuarios_bloqueados'),
